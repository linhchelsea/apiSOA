            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row  col-lg-offset-1">
                        <form method="POST" action="{{ route('lessons.update', $lesson->Id) }}" accept-charset="UTF-8" id="lesson" class="lessonForm" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input class="form-control" name="LessonNameEn" type="text" id="LessonNameEn" value="{{$lesson->LessonNameEn}}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input class="form-control" name="LessonNameVi" type="text" id="LessonNameVi" value="{{$lesson->LessonNameVi}}">
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-10">
                                    ...
                                    <br>
                                    <p><img id="image-show" src="{{ asset('/storage/lesson/'.$lesson->LessonPathImage) }}" alt="avatar" class="img-responsive" width="200px" height="200px"></p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="form-group">
